...
if(isset($themeum_options['custom-preset-en']) && $themeum_options['custom-preset-en']) {
	...
	if(isset($link_color)){
		...
		.wpmm-gridcontrol-left:hover, .wpmm-gridcontrol-right:hover{ background-color: '. esc_attr($link_color) .'; }';
		...
		$output .= '.spinners{ border-top: 5px solid '.$link_color.'; }';
	}
}
...
if(isset($themeum_options['custom-preset-en']) && $themeum_options['custom-preset-en']) {
	...
	if(isset($themeum_options['hover-color'])){
		...
		.woocommerce a.button:hover,.woocommerce input.button:hover,#main-menu .wp-megamenu-wrap .signup-signin a:hover{ background: '.esc_attr($themeum_options['hover-color']) .'; }';
	}
}
